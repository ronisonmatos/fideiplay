...
export const SOLITARIO_NIVEIS_FIXOS: NivelSolitario[] = [
  { id: 'nivel-1', numero: 1, colunas: 3, categorias: 2, totalCartas: 8,  movimentos: 100 },
  { id: 'nivel-2', numero: 2, colunas: 3, categorias: 3, totalCartas: 12, movimentos: 80 },
  { id: 'nivel-3', numero: 3, colunas: 4, categorias: 3, totalCartas: 16, movimentos: 70 },
  { id: 'nivel-4', numero: 4, colunas: 4, categorias: 4, totalCartas: 20, movimentos: 60 },
  { id: 'nivel-5', numero: 5, colunas: 5, categorias: 4, totalCartas: 24, movimentos: 50 },
];
...
export function montarBaralho(nivel: NivelSolitario, categoriasDisponiveis: CategoriaComCartas[]): BaralhoMontado | null {
  ...
  // O baralho é formado só por cartas reais, em unidades de 4 da mesma categoria —
  // cada grupo fecha com 4 cartas iguais. Sem coringa e sem Carta Categoria: as duas
  // deixavam o total fora do múltiplo de 4 e podiam "sobrar" no fim, travando a
  // partida (a Carta Categoria ficava órfã quando as 4 reais fechavam sem ela).
  return {
