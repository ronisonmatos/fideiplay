...
const styles = StyleSheet.create({
  ...
  conclusaoEmoji: { fontSize: 72 },
  conclusaoTitulo: { fontSize: 28, fontWeight: '900', textAlign: 'center' },
  ...
  xpCardText: { color: C.gold, fontSize: 28, fontWeight: '900' },
